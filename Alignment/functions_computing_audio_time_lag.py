...
def save_script_backup():
    ...
    original = r'/home/dan/Projects/PseudoOnlineTests_for_RTCoG/Scripts/Recent/SpellerAnalysis/functions_computing_audio_time_lag.py'
    target   = r'/mnt/shared/danprocessing/BACKUP/Projects/PseudoOnlineTests_for_RTCoG/Scripts/SpellerAnalysis/functions_computing_audio_time_lag.py'
...
def extract_audio_from_video(block_id, date, dir_intermediates, patient_id, task):
    """
    DESCRIPTION:
    ...
    # Creating the base audio path.
    dir_audio = dir_intermediates + patient_id + '/' + task + '/' + 'Audio/' + date + '/'
    ...
    audio_signal_path = dir_audio + filename_wav
...
def save_time_lag(block_id, date, dir_intermediates, patient_id, t_lag, task):
    """
    DESCRIPTION:
