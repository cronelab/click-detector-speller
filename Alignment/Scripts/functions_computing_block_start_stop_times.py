...
def extract_start_stop_times_from_txt(block_id, date, dir_base, fps, patient_id):
    """
    DESCRIPTION:
...
def writing_to_text_file(block_id, date, dir_base, frame_block_start, frame_block_end, patient_id,\
