...
# import mp_pose_estimation_params
import numpy as np
import os
import pickle
import shutil
...
def save_script_backup():
    ...
    original = r'/home/dan/Projects/PseudoOnlineTests_for_RTCoG/Scripts/Recent/SpellerAnalysis/functions_speller_analysis_online_detections.py'
    target   = r'/mnt/shared/danprocessing/BACKUP/Projects/PseudoOnlineTests_for_RTCoG/Scripts/SpellerAnalysis/functions_speller_analysis_online_detections.py'
...
def saving_click_latencies(block_id, date, dir_intermediates, movement, patient_id, t_click_latencies, task):
    ...
    this_directory       = dir_intermediates + patient_id + '/' + task + '/ClickLatencies/' + date + '/'
